...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    backgroundColor: (checked) =>
      checked ? theme.palette.primary.light : theme.palette.secondary.light,
  ...
  textField: {
    ...
    borderRadius: 10,
    backgroundColor: (checked) =>
      checked ? theme.palette.primary.dark : theme.palette.secondary.dark,
  },
  inputStyle: {
    color: (checked) => (checked ? "#ffff" : "#000000"),
    fontSize: 48,
  ...
  return (
    <Box className={classes.root}>
      <Box
        disply="flex"
        flexDirection="column"
        width={isSmallScreen ? 350 : 540}
      >
        <Box display="flex" justifyContent="space-between">
          <Typography variant="h4">calc</Typography>
        ...
        <Box className={classes.buttonBox}>
          ...
          <Box className={classes.buttonSecondaryBox}>
            <ButtonCompo onClick={reset} buttonprops="reset" uncommon>
              RESET
            </ButtonCompo>
            <ButtonCompo onClick={getResult} buttonprops="equalsTo" uncommon>
              =
            </ButtonCompo>
          </Box>
        </Box>
